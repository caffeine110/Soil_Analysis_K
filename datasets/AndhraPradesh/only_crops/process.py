...
if df.any( df['Crop_before'] == 'Ground Nat' ):
    value = "groundnut"
    df['Crop_before']=value
...
with open('only_crops.csv') as csvfile:
    ...
    for row in reader:
        other = row
        if ( row['Crop_before']=='GROUND NUT' or row['Crop_before']=='Ground Nut' or row['Crop_before']=='GroundNut' or row['Crop_before']=='Ground nut' or row['Crop_before']=='Groundnut' or row['Crop_before']=='G.Nut' or row['Crop_before']=='Grounat' or row['Crop_before']=='groundnut'or row['Crop_before']=='ground nut' or row['Crop_before']=='Ground Nat'):
        ...
        elif ( row['Crop_before']=='SUGER CANE ' or row['Crop_before']=='Sugar Cane' or row['Crop_before']=='Sugarcane' or row['Crop_before']=='suger cane' or row['Crop_before']=='Sugarcane ' or row['Crop_before']=='Sugercane'):
        ...
        elif ( row['Crop_before']=='Cottan' or row['Crop_before']=='Cotton' or row['Crop_before']== 'cotton'):
